...
<div class="container">
  <div class="row mb-1">
      <div class="col-sm-12">
      <p class="lead">This service allows you to exchange messages with other users. Strong
  ...
  <div class="card-deck">
      <div class="card border-success text-center">
          <a href="/login" role="button" class="btn-like">
          <div class="card-body">
  ...
  <div class="row mt-4">
      ...
      <p>This is my (slightly late!) entry for the
