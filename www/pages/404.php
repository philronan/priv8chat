...
10vmax;color:rgba(0,255,60,.7);transform:translateY(-50%);}a:link,a:visited{color:#6f8;
...
c.width=window.innerWidth;h=Math.max(15,Math.min(c.width,c.height)/42);w=h*.7;m=c.width/w;x=
